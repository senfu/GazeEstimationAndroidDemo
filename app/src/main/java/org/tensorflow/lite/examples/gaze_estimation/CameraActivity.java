...
import org.tensorflow.lite.examples.gaze_estimation.tflite.Classifier.Recognition;
...
//              .setModel(new File("/data/local/tmp/ddrnet23s.dlc"));
//    } catch (IOException e) {
//      Log.d("weiming", "build network exception");
//    }
//    final NeuralNetwork network = builder.build();
//
//    final FloatTensor tensor = network.createFloatTensor(1,512, 512, 3);
//    float[] input = new float[512*512*3];
//    tensor.write(input, 0, 512*512*3);
//    final Map<String, FloatTensor> inputsMap = new HashMap<>();
//    inputsMap.put("input", tensor);
//
...
//      Log.d("weiming", output.getKey().toString());
//    }
...
//    numThreads = Integer.parseInt(threadsTextView.getText().toString().trim());
  ...
  public void onPreviewFrame(final byte[] bytes, final Camera camera) {
    ...
    processImage();
//    Bitmap result_image = processImage();
//    ImageView imageView = (I  mageView) findViewById(R.id.imageView);
